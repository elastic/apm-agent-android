package co.elastic.apm.compile.tools.notice.plugins;
...
import co.elastic.apm.compile.tools.notice.tasks.CreateDependenciesListTask;
import co.elastic.apm.compile.tools.notice.tasks.CreateNoticeTask;
import co.elastic.apm.compile.tools.notice.tasks.NoticeMergerTask;
import co.elastic.apm.compile.tools.notice.tasks.rootproject.SubprojectNoticesCollectorTask;
import co.elastic.apm.compile.tools.notice.tasks.rootproject.SubprojectPomLicensesMergerTask;
