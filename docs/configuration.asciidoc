...
You can provide your application name, version and its environment name dynamically by setting those when building your `ElasticApmConfiguration` instance as show below:
