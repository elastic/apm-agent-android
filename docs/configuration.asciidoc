...
*Just getting started?* Start with <<setup,Getting started>>.

[discrete]
=== Initialization configuration

Available from the Elastic agent builder shown in
<<agent-setup,Agent setup>>, the following are its
...
<<why-does-my-app-have-to-be-referred-to-as-service,why your app is referred to as a "service">>.
...
<<how-to-get-my-elastic-stack-export-endpoint,how to find it>>.
...
<<how-to-create-an-api-key,how to create one>>.
...
look at <<intercepting-resources,intercepting resources>>.
...
<<intercepting-attributes,intercepting attributes>>.
====
...
to manage features like <<disk-buffering,disk buffering>> and
also to establish a connection with the Elastic export endpoint based on
the provided <<export-connectivity,export connectivity>> values. You
...
<<export-connectivity,export connectivity>> setters, at any time, by
setting a new
