...
link:faq.md#why-is-enabling-desugaring-support-on-apps-with-minsdk-below-26-necessary[FAQ]
...
object. link:how-tos.md#how-to-get-my-android-application-instance[Get
...
link:faq.md#why-does-my-app-have-to-be-referred-to-as-service[FAQ] for
more information.
. This is the Elastic endpoint where all your telemetry will be
exported.
link:how-tos.md#how-to-get-my-elastic-stack-export-endpoint[Get your
Elastic endpoint].
. Use an API key to connect the agent to the Elastic Stack.
link:how-tos.md#how-to-create-an-api-key[Create an API key].
...
link:manual-instrumentation.md[manually] or
link:automatic-instrumentation.md[automatically], view it in Kibana by
...
look at the link:configuration.md[configuration page].
* In the link:#hello-world[simple example], you've _manually_ sent a
span, so you've created some link:manual-instrumentation.md[manual
...
link:automatic-instrumentation.md[Automatic instrumentation].
...
For more details, refer to link:manual-instrumentation.md[Manual
instrumentation].
