...
import co.elastic.otel.android.compilation.tools.tasks.rootproject.SubprojectNoticesCollectorTask;
import co.elastic.otel.android.compilation.tools.tasks.rootproject.SubprojectPomLicensesMergerTask;
