 ...
 * under the License.
 */
package co.elastic.apm.android.plugin.testutils.buildgradle;

import co.elastic.apm.android.plugin.testutils.buildgradle.block.impl.ElasticBlockBuilder;
import co.elastic.apm.android.plugin.testutils.buildgradle.block.impl.PluginBlockBuilder;
import co.elastic.apm.android.plugin.testutils.buildgradle.block.impl.RepositoriesBlockBuilder;
import co.elastic.apm.android.plugin.testutils.buildgradle.block.impl.android.AndroidBlockBuilder;
