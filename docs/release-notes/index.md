...
* Add the `elasticOtel` Gradle DSL for build-time agent configuration and variant-level bytecode instrumentation settings: [#832](https://github.com/elastic/apm-agent-android/pull/832)
