...
public class InstrumentationScopeInfoConverter extends Converter<InstrumentationScopeInfo, InstrumentationScope> {

    @Override
    protected InstrumentationScope doConvert(Mapper mapper, InstrumentationScopeInfo from) {
