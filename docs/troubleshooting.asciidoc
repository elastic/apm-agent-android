...
link:configuration.asciidoc#internal-logging-policy[internal logging policy]
configuration.

[discrete]
=== Connectivity to the Elastic Stack

If after following the link:getting-started.asciidoc[getting started] guide
and configuring your Elastic Stack
link:configuration.asciidoc#export-connectivity[endpoint parameters], you
...
link:how-tos.asciidoc#how-to-configure-ssltls[how to configure SSL/TLS] for
more information.
