...
Configuration options marked with Dynamic true can be changed at runtime when set from Kibana's https://www.elastic.co/guide/en/kibana/master/agent-configuration.html[central configuration].
