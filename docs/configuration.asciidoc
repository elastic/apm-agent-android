...
By default, the Elastic agent generates a session ID on app launch and keeps it until after an idle period of time of 30 minutes, restarting the timeout time on every APM-related transaction.
