...
*Just getting started?* Start with link:getting-started.asciidoc[Getting
started].

=== Initialization configuration

Available from the Elastic agent builder shown in
link:getting-started.asciidoc#agent-setup[Agent setup], the following are its
...
link:faq.asciidoc#why-does-my-app-have-to-be-referred-to-as-service[why your
...
link:how-tos.asciidoc#how-to-get-my-elastic-stack-export-endpoint[how to find
it].
...
link:how-tos.asciidoc#how-to-create-an-api-key[how to create one].
...
to manage features like link:index.asciidoc#disk-buffering[disk buffering] and
