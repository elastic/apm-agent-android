package co.elastic.apm.compile.tools.notice.tasks;
...
import co.elastic.apm.compile.tools.notice.data.ArtifactIdentification;
import co.elastic.apm.compile.tools.notice.data.ArtifactLicense;
import co.elastic.apm.compile.tools.notice.data.Gav;
import co.elastic.apm.compile.tools.notice.data.License;
import co.elastic.apm.compile.tools.notice.tasks.subprojects.BasePomTask;
import co.elastic.apm.compile.tools.notice.utils.LicensesProvider;
import co.elastic.apm.compile.tools.notice.utils.PomReader;
import co.elastic.apm.compile.tools.notice.utils.TextUtils;
