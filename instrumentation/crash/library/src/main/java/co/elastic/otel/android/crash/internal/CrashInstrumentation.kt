...
class CrashInstrumentation : Instrumentation {
    override fun install(
        ...
        Thread.setDefaultUncaughtExceptionHandler(ElasticExceptionHandler.create(agent, delegate))

        return Instrumentation.Installation {
            // On uninstall, restore the previous handler
