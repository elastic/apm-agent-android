 ...
 * under the License.
 */
package co.elastic.apm.android.plugin.testutils.buildgradle.block.impl.settings;

import co.elastic.apm.android.plugin.testutils.buildgradle.block.impl.BuildscriptBlockBuilder;
...
public class SettingsGradleBuilder {
    ...
    public String build() {
        return buildscriptBlockBuilder.build();
    }
}
