...
### Features and enhancements [elastic-apm-android-agent-170-features-enhancements]

* Add the app.build_id resource attribute, generated by the Gradle plugin by default and configurable per project, build type, or product flavor: [#832](https://github.com/elastic/apm-agent-android/pull/832)
* Add the android.elasticOtel Gradle DSL for build-time agent configuration and variant-level bytecode instrumentation settings: [#832](https://github.com/elastic/apm-agent-android/pull/832)
* Update upstream OpenTelemetry dependencies to OpenTelemetry Java 1.63.0 and OpenTelemetry Java Instrumentation 2.29.0: [#830](https://github.com/elastic/apm-agent-android/pull/830)

### Fixes [elastic-apm-android-agent-170-fixes]

* Fix Kotlin 2.4 compatibility issues: [#817](https://github.com/elastic/apm-agent-android/pull/817)
