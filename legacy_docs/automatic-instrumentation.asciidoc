...
link:manual-instrumentation.md[manual instrumentation].
...
link:getting-started.md#gradle-setup[agent] is added.
. link:getting-started.md#agent-setup[Initialize the agent] the same way
