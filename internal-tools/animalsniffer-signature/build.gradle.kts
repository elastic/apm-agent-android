...
android {
    namespace = "co.elastic.otel.android.animalsniffer.signature"
    compileSdk = (property("elastic.android.compileSdk") as String).toInt()
}
...
dependencies {
    signature("com.toasttab.android:gummy-bears-api-${project.property("elastic.android.minSdk")}:0.14.0@signature")
